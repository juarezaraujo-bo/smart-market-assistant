...
-- 10. Memoria controlada do assistente
...
-- 11. Idempotencia do webhook Telegram
...
CREATE INDEX IF NOT EXISTS idx_telegram_connections_chat_id ON public.telegram_connections (chat_id);
CREATE INDEX IF NOT EXISTS idx_telegram_connections_cliente_id ON public.telegram_connections (cliente_id);
CREATE INDEX IF NOT EXISTS idx_assistant_conversations_cliente_chat ON public.assistant_conversations (cliente_id, telegram_chat_id);
CREATE INDEX IF NOT EXISTS idx_assistant_messages_conversation_created ON public.assistant_messages (conversation_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_telegram_processed_updates_chat_id ON public.telegram_processed_updates (chat_id);
